...
">
	...
	<a class="px-2 sm:px-4 py-2 text-center flex-grow border-x border-white dark:border-black" href="#calendar" x-data @click.prevent="$dispatch('navigation-toggle')">🗓 Calendar</a>
